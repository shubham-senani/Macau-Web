...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <h1>Macau Privacy Policy</h1>
      <p>Last updated: May 11, 2024</p>
      <p>
        Thank you for using Macau. Your privacy is important to us. This Privacy
        Policy explains how we collect, use, disclose, and safeguard your
        information when you use our application and services. Please read this
        Privacy Policy carefully. By using the Service, you agree to the
      ...
      <p>
        Words with initial capital letters have specific meanings defined under
        the following conditions. These definitions apply regardless of whether
      ...
      <ul>
        ...
        <li>
          <strong>Application:</strong> Refers to Macau, the software program
          provided by the Company.
        </li>
        <li>
          <strong>Company:</strong> (referred to as either "the Company", "We",
          "Us" or "Our" in this Agreement) refers to Macau.
        </li>
        <li>
        ...
        <li>
          ...
          social network through which a User can log in or create an account to
          use the Service.
        </li>
        <li>
      ...
      <p>
        This data may include information such as Your Device's Internet
      ...
      <p>
        You can create an account and log in to use the Service through the
      ...
      <p>
        ...
        to provide such information and Personal Data, You are giving Us
      ...
      <p>
        While using Our Application, to provide features of Our Application, We
      ...
      <ul>
        ...
        <li>Location Data, including background location data</li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          items, or services You have purchased or any other contract with Us
          through the Service.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <strong>With Affiliates:</strong> We will require those affiliates to
        ...
        <li>
          ...
          or otherwise interact in public areas with other users, such
      ...
      <p>
        ...
        the processing are located. This means that your information may be
      ...
      <h2>7. Delete Your Personal Data</h2>
      <p>
      ...
      <h2>13. Background Location Access</h2>

      <h3>Background Location Data Collection</h3>
      <p>
        While using Our Application, and with Your prior permission, We may
        collect and process location data, including background location data.
        This is essential for providing navigation and location-based services
        that are core to Our Application's functionality.
      </p>

      <h3>Duration and Purpose of Background Location Access</h3>
      <p>
        We only access background location data for short durations,
        specifically for a maximum of 1 minute, when You start navigation to a
        selected property. This is to ensure accurate and real-time navigation
        directions. The background location access will automatically stop after
        this duration.
      </p>

      <h3>User Control Over Background Location Access</h3>
      <p>
        You can enable or disable access to background location data at any time
        through Your Device settings. We ensure that background location data is
        collected only with Your explicit consent and for the specified purpose.
      </p>

      <h3>Use and Storage of Background Location Data</h3>
      <p>
        We use the collected background location data to improve the accuracy of
        our navigation services. The data may be uploaded to the Company's
        servers and/or a Service Provider's server or it may be stored on Your
        device, depending on the specific service functionality.
      </p>

      <h3>Security of Background Location Data</h3>
      <p>
        We take all necessary measures to protect the background location data,
        ensuring it is treated securely and in accordance with this Privacy
        Policy. However, please note that no method of transmission over the
      ...
      <ul>
        <li>By email: <a href="mailto:shubhamsenani9@gmail.com">shubhamsenani9@gmail.com</a></li>
      </ul>
